...
public class Robot extends TimedRobot {
  ...
  public void robotPeriodic() {
    SmartDashboard.putNumber("RPM", robotContainer.getShooterEncoder().getRate() * 60);
    SmartDashboard.putNumber("Rotations", robotContainer.getShooterEncoder().getDistance());
